                ...
                <div class="flex items-center">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open" type="button"
                            ...
                            <span class="text-sm font-medium hidden lg:inline-block">Admin</span>
                            ...
                            <li>
                                <a href=""
                                    ...
                                    <svg class="w-6 h-6 text-gray-700 group-hover:text-gray-900" fill="currentColor"
                                        viewBox="0 0 24 24">
                                        <path
                                            d="M12 12c2.7 0 4.9-2.2 4.9-4.9S14.7 2.2 12 2.2 7.1 4.4 7.1 7.1 9.3 12 12 12zm0 2.2c-3.3 0-9.8 1.7-9.8 5v2.7h19.6v-2.7c0-3.3-6.5-5-9.8-5z" />
                                    </svg>
                            ...
                            <li>
                                <a href=""
                                    ...
                                    <svg class="w-6 h-6 text-gray-700 group-hover:text-gray-900" fill="currentColor"
                                        viewBox="0 0 24 24">
                                        <path
                                            d="M16 11c1.7 0 3-1.3 3-3s-1.3-3-3-3-3 1.3-3 3 1.3 3 3 3zm-8 0c1.7 0 3-1.3 3-3S9.7 5 8 5 5 6.3 5 8s1.3 3 3 3zm0 2c-2.7 0-8 1.3-8 4v3h8v-3h2v3h8v-3c0-2.7-5.3-4-8-4h-2z" />
                                    </svg>
                                    <span class="ml-3 flex-1 whitespace-nowrap">Anggota</span>
                                </a>
                            </li>
